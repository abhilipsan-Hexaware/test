...
using ElmahCore.Mvc;
using ElmahCore;
using dotnetpipelinesvc.Api.Filters;
using dotnetpipelinesvc.BusinessServices.Installer;

namespace dotnetpipelinesvc.Api.Installer
{
    public class APIInstaller
    {
        ...
        public void Install()
        {
            ...
            {
                c.SwaggerDoc("v1", new OpenApiInfo { Title = "dotnetpipelinesvc API", Version = version + "-" + branch});
            });
